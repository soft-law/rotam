...
export default function Beneficts(){
    ...
    return(
        <div style={{textAlign:"center", margin:"4rem 1rem 3rem 1rem"}}>
            <p style={{fontSize:"2rem", fontWeight:"normal", color: "#1B5E20"}}>Unlock the Future of Car Trading:</p>
            <p style={{fontSize:"2rem", fontWeight:"normal", color:"#0D47A1"}}>Secure, Transparent, Decentralized</p>
            <BenefictsCards/>
